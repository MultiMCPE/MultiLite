...
class SubChunk {
	 ...
	 * @return string
	 */
	public function networkSerialize($protocol) : string{
		return $protocol >= Info::PROTOCOL_120 ? "\x00" . $this->ids . $this->data : "\x00" . $this->ids . $this->data . $this->skyLight . $this->blockLight;
	}
