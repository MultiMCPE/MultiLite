	...
	public function execute(CommandSender $sender, $currentAlias, array $args){
		...
		if($mode === "reset"){
			...
			if($paste){
				...
				$agent = [
				    "User-Agent: " . $sender->getServer()->getName() . " " . $sender->getServer()->getPocketMineVersion(),
				...
				$sender->getServer()->getScheduler()->scheduleAsyncTask(new class($sender, $host, $agent, $data) extends AsyncTask{
					/** @var string */
					private $host;
					 ...
					 */
					public function __construct(CommandSender $sender, string $host, array $agent, array $data){
                    ...
                    public function onRun() {
			        	...
			        	$ch = curl_init("https://$host?upload=true");
					...
					public function onCompletion(Server $server){
			        	...
			        	if (!is_array($response = json_decode($this->getResult(), true)) or !isset($response["id"])) {
