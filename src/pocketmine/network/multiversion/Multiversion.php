...
abstract class Multiversion {
	 ...
	 */
	public static function getPlayerInventory(Player $player, $contents) {
		...
		return new $inventoryClass($player, $contents);
	}
	 ...
	 * @param integer $slot
	 */
	public static function sendContainerSlot(Player $player, int $windowId, $item, $slot) {
